...
class Parameter(QDialog, Ui_Dialog):
    ...
    def ProcessSendButton(self):
        ...
        print("ProcessSendButton in Parameter.py before change : ")
        print(pageAddress, pagePort, pageEndian, pagePktId,
                               cmdCode, param_string.strip())
        # cmdCode = 0x888
        # param_string = "--string=\"200:testjuntheworldAAAAAAAAAAAAAAAAAAAAAABBBBBBBBBB\""
        ...
        print("ProcessSendButton in Parameter.py after cgabge: ")
        print(pageAddress, pagePort, pageEndian, pagePktId,
                               cmdCode, param_string.strip())
...
if __name__ == '__main__':
    ...
    print("start Parameter.py log by jun")
    #
